...
public class Match : IMatch
{
    ...
    {
        private set {this.ValidateTeamName(value); this._homeTeamName = value; }
        get {return this._homeTeamName;}
    }

    public string AwayTeamName
    {
        private set {this.ValidateTeamName(value); this._awayTeamName= value; }
        get {return this._awayTeamName;}
    }

    public long MatchStart
    {
        private set {this._matchStart = value; }
        get {return this._matchStart;}
    }

    private int HomeScore
    {
        set {this.ValidateMatchScore(value);  this._homeScore= value; }
        get {return this._homeScore;}
    }
    
    private int AwayScore
    {
        set {this.ValidateMatchScore(value);  this._awayScore= value; }
        get {return this._awayScore;}
    }
    ...
    {
        if (!typeof(Match).IsInstanceOfType(match))
        {
